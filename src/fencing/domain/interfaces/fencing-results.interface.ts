export class MetadataRequestResultDto {
  discipline!: string;
  gender!: string;
  sportEvent!: string;
  category?: string;
...
export class ParticipantRequestResultDto {
  result!: string;
...
export class GroupRequestResultDto {
  result!: string;
  groupId!: number;
  name!: string;
  delegation!: string;
...
export class PeriodResultRequestResultDto {
  result!: string;
  unitCode?: string;
  name!: string;
  order!: number;
...
export class GlobalResultRequestResultDto {
  result!: string;
  groups?: GroupRequestResultDto[];
  participants?: ParticipantRequestResultDto[];
  decorator!: unknown[];
