...
export class CreateStartListExamples {
  ...
  createBasicStartList() {
    ...
    const startListDto = this.fencingToParticipantMapper.createStartListDto(tireurs as TireurInMatch[], metadata, [] as {ID: string, Licence: string}[]);
  ...
  createPhaseStartList(phase: string, unit: string) {
    ...
    const startListDto = this.fencingToParticipantMapper.createStartListDto(tireurs, metadata, [] as {ID: string, Licence: string}[]);
