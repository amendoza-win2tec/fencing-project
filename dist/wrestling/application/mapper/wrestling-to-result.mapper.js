...
exports.WrestlingToResultMapper = void 0;
...
let WrestlingToResultMapper = class WrestlingToResultMapper {
    constructor(participantService) {
        this.participantService = participantService;
    }
    createResultDto(wrestlers, metadata) {
        const participants = [];
        const groups = [];
...
exports.WrestlingToResultMapper = WrestlingToResultMapper;
exports.WrestlingToResultMapper = WrestlingToResultMapper = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [participant_service_1.ParticipantService])
], WrestlingToResultMapper);
//# sourceMappingURL=wrestling-to-result.mapper.js.map